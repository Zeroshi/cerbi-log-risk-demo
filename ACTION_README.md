...
Once the dedicated Marketplace repository is published, add this to a workflow after checkout:
...
The GitHub Action wrapper is intended to be distributed under the MIT License. Cerbi Scanner package licensing remains governed by the package/repository terms for the installed scanner version.

## Links

- Product: https://www.cerbi.io/
- Scanner quickstart: https://www.cerbi.io/docs/scanner/quickstart
- Support: https://github.com/Zeroshi/cerbi-log-risk-demo/issues
